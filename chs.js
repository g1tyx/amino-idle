...
var cnItems = {
    ...
    "Biomites:": "生物螨：",
    "Calorimetric Granulum (cost: 35,000s, 10,000a)": "量热颗粒（成本：35,000s，10,000a）",
    "Cave View": "洞穴景观",
    ...
    "Discovery View": "发现视图",
    "Echo": "回声",
    "Echo Chamber (cost: 3000n 650i 1500w 10Ke)": "回声室（成本：3000n 650i 1500w 10Ke）",
    ...
    "Endoplasmic Reticulum (cost: 1250n 250i 500w)": "内质网（成本：1250n 250i 500w）",
    "Energy": "能量",
    "Energy:": "能量：",
    ...
    "Feathered Antenna (cost: 1750n 100i 750w)": "羽毛天线（成本：1750n 100i 750w）",
    ...
    "Lophotrichous Flagella (cost: 15,000n 15,000e)": "Lophotrichous鞭毛（成本：15,000n 15,000e）",
    ...
    "Membrane Thickness (cost: 200n 40i)": "膜厚度（成本：200n 40i）",
    "Mini-Nucleus": "迷你核",
    "Mini-Tendon": "迷你肌腱",
    "Mitochondria (cost: 1750n 100i 750w)": "线粒体（成本：1750n 100i 750w）",
    "Monotrichous Flagella (cost: 7500n 750i 1250w 2500e)": "单毛鞭毛（成本：7500n 750i 1250w 2500e）",
    ...
    "Nourishment": "营养",
    "Nourishment:": "营养：",
    "Nucleus (cost: 600n 100i 200w)": "细胞核（成本：600n 100i 200w）",
    ...
    "Radiators (cost: 100n 50i 20w)": "散热器（成本：100n 50i 20w）",
    "Research": "研究",
    "Reset Game": "重置游戏",
    ...
    "Resonance Tendrils (cost: 4000n 650i 1750w 400e)": "共振卷须（成本：4000n 650i 1750w 400e）",
    "Sagan's Symphony: Somewhere, something incredible is waiting to be known.": "萨根交响曲：在某个地方，有一些令人难以置信的事情等待着我们去发现。",
    "Save Game": "保存游戏",
    "Sense": "感觉",
    "Sensors (cost: 50n 10i)": "传感器（成本：50n 10i）",
    "Sensory Pulsars (cost: 5000n 650i 2000w 500e)": "感官脉冲星（成本：5000n 650i 2000w 500e）",
    ...
    "Soul": "灵魂",
    "Spikes (cost: 1250n 100i 1750w)": "尖峰（成本：1250n 100i 1750w）",
    ...
    "Suction Cups (cost: 1750n 100i 750w)": "吸盘（成本：1750n 100i 750w）",
    "Support on Patreon": "对 Patreon 的支持",
    "Synaptic Glacialis (cost: 20,000b 50,000z)": "冰川突触（成本：20,000b 50,000z）",
